...
public class InstallUI extends AbstractIT {
  ...
  @Before
  public void startUp() {
    driver = WebDriverManager.getWebDriver("http://prabhu-zeppelin-secure-1.openstacklocal:8080");
  }
...
//    driver.quit();
  ...
  public void testAngularDisplay() throws Exception {
    try {
      ...
      String host = "prabhu-zeppelin-secure-1.openstacklocal\nprabhu-zeppelin-secure-1.openstacklocal";
      long waitTime = 10000;
      ...
      pollingWait(By.xpath("//*[@id='confirm-hosts']/div[2][contains(.,'Some warning')]"), (5 * 60 * 1000));
